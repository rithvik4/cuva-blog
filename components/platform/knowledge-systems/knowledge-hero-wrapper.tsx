...
import { KnowledgeHero } from "@/components/platform/knowledge-systems/knowledge-hero"

export function KnowledgeHeroWrapper() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (heroRef.current) {
        ...
        // Hide header when scrolled past half of hero section
